...
def get_config():
    ...
    cfg.root = '/pscratch/sd/t/tvnguyen/stream_sbi_shared/datasets/'
    cfg.name = '6params-uni-ta25-2'
    cfg.root_out = '/pscratch/sd/t/tvnguyen/stream_sbi_shared/npe/preprocessed_datasets/'
    cfg.name_out = '6d-uni-spline-sf1-2'

    # data configuration
    cfg.num_datasets = 20
    cfg.start_dataset = 0
    cfg.labels = ['log_M_sat', 'log_rs_sat', 'vz', 'vphi', 'r', 'phi']
    cfg.features = ['phi1', 'phi2', 'pm1', 'pm2', 'vr', 'dist']
