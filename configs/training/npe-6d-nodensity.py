...
def get_config():
    ...
    cfg.name = 'spline-sf1-6d-nodensity'
    cfg.enable_progress_bar = True
    cfg.overwrite = False
    cfg.reset_optimizer = False
    cfg.checkpoint = 'epoch=377-step=493290-train_loss=-3.8271-val_loss=-4.8137.ckpt'
    ...
    cfg.scheduler.warmup_steps = 25_000
