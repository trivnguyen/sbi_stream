...
def get_config():
    ...
    cfg.name = 'spline-sf1-5d-large-nodensity'
    cfg.enable_progress_bar = True
    cfg.overwrite = False
    cfg.reset_optimizer = False
    cfg.checkpoint = 'epoch=63-step=67520-train_loss=-10.5678-val_loss=-9.9424.ckpt'
