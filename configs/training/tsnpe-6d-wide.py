...
def get_config():
    ...
    cfg.data.root = '/pscratch/sd/t/tvnguyen/stream_sbi_shared/snpe/datasets/apt-runs-widepriors'
    ...
    cfg.workdir = '/pscratch/sd/t/tvnguyen/stream_sbi_shared/snpe/trained-models/apt-runs-widepriors'
    cfg.name = 'spline-sf1-6d'
    cfg.enable_progress_bar = True
    cfg.overwrite = True
    cfg.reset_optimizer = True
    cfg.checkpoint = '/pscratch/sd/t/tvnguyen/stream_sbi_shared/snpe/trained-models/apt-runs-widepriors/spline-sf1-6d/round-0/lightning_logs/checkpoints/epoch=366-step=197446-train_loss=0.0758-val_loss=0.0423.ckpt'
    ...
    cfg.prior.prior_min = [-4, -1, -200, -200, 0, 0, ]
    cfg.prior.prior_max = [-2, 0, 200, 200, 3, 360]
