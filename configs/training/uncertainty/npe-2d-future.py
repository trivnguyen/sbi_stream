...
def get_config():
    ...
    cfg.seed_data = 465645
    cfg.seed_training = 2146598
    cfg.seed_infer = 3254

    # data configuration
    cfg.data = config_dict.ConfigDict()
    cfg.data.root = '/pscratch/sd/t/tvnguyen/stream_sbi_shared/npe/preprocessed_datasets/uncertainty'
    cfg.data.name = '2d-spline-future'
    ...
    cfg.workdir = '/pscratch/sd/t/tvnguyen/stream_sbi_shared/npe/trained-models/uncertainty'
    cfg.name = 'spline-sf1-2d-future'
    ...
    cfg.featurizer.d_feat_in = cfg.data.input_dim * 2
    ...
    cfg.flows.features = cfg.data.output_dim
